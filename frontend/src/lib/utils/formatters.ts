...
/**
 * Locale for all displayed dates. Pinned rather than left to the host default, so a date reads
 * the same in dev, in CI, and in every visitor's browser; day-first matches the European
 * presentation used elsewhere (e.g. prices in EUR).
 */
